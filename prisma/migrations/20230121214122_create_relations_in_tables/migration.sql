/*
  ...
  - You are about to drop the column `habid_id` on the `habit_week_day` table. All the data in the column will be lost.
  - Added the required column `habit_id` to the `habit_week_day` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_habit_week_day" ("id", "week_day") SELECT "id", "week_day" FROM "habit_week_day";
